...
urlpatterns = [
    ...
    path(
        "species/",
        SpeciesListView.as_view(),
        name="species-list",
    ),
    path(
        "species/create/",
        SpeciesCreateView.as_view(),
        name="species-create",
    ),
    path(
        "species/<int:pk>/update/",
        SpeciesUpdateView.as_view(),
        name="species-update",
    ),
    path(
    ...
    path(
        "pet_owners/<int:pk>/update/",
        PetOwnerUpdateView.as_view(),
        name="pet-owner-update",
    ),
    path(
        "pet_owners/<int:pk>/delete/",
        PetOwnerDeleteView.as_view(),
        name="pet-owner-delete",
    ),
    path("pet_foods/", PetFoodListView.as_view(), name="pet-food-list"),
    path(
        "pet_foods/<int:pk>/",
        PetFoodDetailView.as_view(),
        name="pet-food-detail"),
    path(
        "pet_foods/create/",
        PetFoodCreateView.as_view(),
        name="pet-food-create"
    ),
    path(
        "pet_foods/<int:pk>/update/",
        PetFoodUpdateView.as_view(),
        name="pet-food-update",
    ),
    path(
        "pet_foods/<int:pk>/delete/",
        PetFoodDeleteView.as_view(),
        name="pet-food-delete",
    ),
]
